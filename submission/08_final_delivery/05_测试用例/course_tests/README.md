...
- repeat-until loops with multi-statement bodies
...
- semantic diagnostics for invalid repeat-until conditions
- syntax diagnostics with caret output
- syntax panic-mode recovery across declaration and statement synchronization points
